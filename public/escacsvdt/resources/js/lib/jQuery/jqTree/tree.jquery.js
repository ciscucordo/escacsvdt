  ...
  JqTreeWidget = (function(_super) {
    ...
    JqTreeWidget.prototype._refreshElements = function(from_node) {
      ...
      createLi = function(node) {
        ...
        //FCF
        //var b = (node.hasChildren() || node.load_on_demand );
        //alert(node.id + "-->" + node.hasChildren() +  " - " + node.load_on_demand + " ** b:" + b);
      ...
      createNodeLi = function(node) {
        ...
        //FCF
        var button_char = _this.options.nodeWithoutChildrenIcon;
        //alert("escaped_named:" + escaped_name);
        
        return $("<li class=\"" + class_string + "\"><div class=\"jqtree-element jqtree_common\"><a class=\"jqtree_common jqtree-toggler\" style=\"color: rgb(153,0,28); font-size: 11px;\" >"+button_char+"</a><span class=\"jqtree-title jqtree_common\" style=\"color: rgb(0,0,255); font-size: 11px; font-family: arial;\">" + escaped_name + "</span></div></li>");
      };
      createFolderLi = function(node) {
        ...
        return $("<li class=\"jqtree_common " + folder_classes + "\"><div class=\"jqtree-element jqtree_common\"><a class=\"jqtree_common " + button_classes + "\" style=\"color: rgb(153,0,28); font-size: 16px;\" >" + button_char + "</a><span class=\"jqtree_common jqtree-title\" style=\"font-weight: bold; color: rgb(0,0,0); font-size: 12px; font-family: arial;\">" + escaped_name + "</span></div></li>");
      };
